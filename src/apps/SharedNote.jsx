...
const SharedNote = () => {
  ...
  if (error) return (
    <div className="h-[100dvh] flex flex-col items-center justify-center bg-gray-50 text-gray-600 p-6 text-center">
  ...
  return (
    <div className="min-h-[100dvh] bg-gray-50/50 p-4 md:p-12 font-sans relative">
