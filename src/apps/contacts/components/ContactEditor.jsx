...
import { ChevronLeft, Check, User, Phone, Mail, MapPin, Briefcase, Calendar, StickyNote, Globe, Hash, Plus, X, Tag, Camera } from 'lucide-react';
...
const ContactEditor = ({ contact, allLabels = [], onSave, onBack }) => {
    const [data, setData] = useState({
        firstName: '', lastName: '', company: '', jobTitle: '', birthday: '', notes: '', isFavorite: false, photo: '',
    ...
    const handlePhotoUpload = (e) => {
        ...
        reader.onload = (event) => {
            ...
            img.onload = () => {
                ...
                // Draw image scaled and cropped to 64x64
                ...
                <div className="max-w-2xl mx-auto flex flex-col gap-6">
                    <div className="flex items-center gap-4 mb-4">
                        <div
                            ...
                            className="group relative w-20 h-20 bg-blue-100 text-[#4285f4] rounded-full flex items-center justify-center text-3xl font-bold flex-shrink-0 overflow-hidden cursor-pointer"
                        >
                            {photoUrl && !imgError ? (
                                <img
                                    src={photoUrl}
                                ...
                                data.firstName ? data.firstName.charAt(0).toUpperCase() : <User size={32} className="group-hover:opacity-10 transition-opacity" />
                            )}
