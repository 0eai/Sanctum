...
import {
  MoveUp, MoveDown, CheckSquare, Square, Star, RotateCcw, Clock, AlertCircle, FileText, Trash2, Move
} from 'lucide-react';

// FIXED: Accepts onOpen to route properly
const TaskCard = ({ task, index, totalActiveCount, onToggle, onOpen, setDeleteConfirm, onMove, onReorder, isDraggable = true }) => (
  <div
